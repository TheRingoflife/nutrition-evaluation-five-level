...
TEXTS = {
    "en": {
        ...
        "subtitle": "ML-Powered Ready Food Health Assessment (5-Class A-E)",
        "description": "This advanced machine learning application uses XGBoost to predict the nutritional healthiness of ready foods based on 6 key nutritional features with 5 health grades (A-E).",
    ...
    "zh": {
        "title": "🍱 营养质量分类器",
        "subtitle": "ML驱动的预制食品健康评估（五分类A-E等级）",
        "description": "这个先进的机器学习应用程序使用XGBoost根据6个关键营养特征预测预制食品的营养健康性，分为5个健康等级（A-E）。",
