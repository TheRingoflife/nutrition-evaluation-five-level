...
if st.sidebar.button("🧮 Predict"):
    ...
    with st.expander("Click to view SHAP force plot"):
        ...
        force_html = shap.force_plot(
            base_value=shap_for_predicted_class.base_values,
            shap_values=shap_for_predicted_class.values,
            features=shap_for_predicted_class.data,
            feature_names=shap_for_predicted_class.feature_names,
            matplotlib=False
        )
